...
//   ✅ Étalon A — Peinture Murale : les deux décisions produit (pertes 8%,
//       arrondi conditionnement) ont été tranchées et codées le 2026-08-16
...
console.log(`Étalons métier non couverts : ${pendingResults.length}/7 (A est couvert et passe)`);
