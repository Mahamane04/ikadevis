...
function LotNavigator({
  ...
  ))), /* @__PURE__ */ React.createElement("nav", { className: "flex-1 overflow-y-auto p-2 space-y-1.5 max-h-[calc(100vh-220px)]", "aria-label": "Navigation des lots de travaux" }, filteredLots.map((lot, idx) => {
...
function QuoteWorkspace({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-neutral-100 flex flex-col pb-36" }, /* @__PURE__ */ React.createElement(
    QuoteHeader,
    {
...
function App({ supabaseSession, supabaseClient, onSignOut }) {
  ...
  const defaultCompany = {
    ...
    currency: "FCFA",
    paymentTerms: "50% \xE0 la commande, solde \xE0 la livraison / r\xE9ception du chantier.",
  ...
  const initialMaterials = [
    ...
    { id: 14, name: "Modules LED \xE9tanches IP67 1.2W Grand Angle", category: "\xC9lectricit\xE9", unitBuy: "Module", unitSize: 1, unitCalc: "u", priceBuy: 650, priceCalc: 650, waste: 2, yieldRate: 0, purchaseMode: "real" },
  ...
  const initialRecipes = [
    ...
    { id: 30, solutionId: 8, type: "material", refId: 14, formula: "SURFACE * 45", label: "Modules LED IP67 1.2W (45 u/m\xB2)", costCategory: "material" },
...
Veuillez d'abord modifier les recettes qui l'utilisent avant de la supprimer.`,
  ...
  const renderProjects = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-[1400px] mx-auto space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-5 rounded-3xl border border-neutral-200 shadow-sm" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-black text-neutral-900 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-folder-tree text-brand-600" }), "Gestion des Affaires & Projets BTP"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500 mt-0.5" }, "Regroupez vos devis initiaux (V1), r\xE9visions (V2, V3) et avenants par chantier.")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 w-full sm:w-auto" }, /* @__PURE__ */ React.createElement("div", { className: "relative flex-1 sm:w-64" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
    ...
    ), /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-magnifying-glass absolute left-2.5 top-1/2 -translate-y-1/2 text-neutral-400 text-xs" })), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
      ...
      /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-plus" }),
      /* @__PURE__ */ React.createElement("span", null, "Nouvelle Affaire")
  ...
  const renderClients = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-[1400px] mx-auto space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-5 rounded-3xl border border-neutral-200 shadow-sm" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-black text-neutral-900 flex items-center gap-2" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-users text-brand-600" }), "R\xE9pertoire Clients & Donneurs d'Ordres"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500 mt-0.5" }, "Centralisez vos contacts, adresses de chantier, NIF/RCCM et historique d'affaires.")), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 w-full sm:w-auto" }, /* @__PURE__ */ React.createElement("div", { className: "relative flex-1 sm:w-64" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "text",
      ...
      return /* @__PURE__ */ React.createElement("div", { key: c.id, className: "bg-white rounded-3xl border border-neutral-200 p-5 shadow-sm space-y-4 hover:border-brand-300 transition-all flex flex-col justify-between" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5" }, /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 rounded-2xl bg-brand-50 text-brand-600 font-black text-sm flex items-center justify-center shrink-0" }, c.name.substring(0, 2).toUpperCase()), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("h3", { className: "font-extrabold text-sm text-neutral-900 truncate" }, c.name), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-neutral-500 font-medium truncate" }, c.contactPerson))), /* @__PURE__ */ React.createElement("div", { className: "bg-neutral-50 rounded-2xl p-3 text-xs space-y-1 text-neutral-600 border border-neutral-100" }, c.taxId && /* @__PURE__ */ React.createElement("p", { className: "font-mono text-[10px] text-neutral-500" }, /* @__PURE__ */ React.createElement("strong", null, "NIF :"), " ", c.taxId), c.phone && /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-phone mr-1.5 text-neutral-400" }), " ", c.phone), c.email && /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-envelope mr-1.5 text-neutral-400" }), " ", c.email), c.address && /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-location-dot mr-1.5 text-neutral-400" }), " ", c.address, ", ", c.city))), /* @__PURE__ */ React.createElement("div", { className: "pt-2 border-t border-neutral-100 flex justify-between items-center text-xs text-neutral-500" }, /* @__PURE__ */ React.createElement("span", null, clientProjects.length, " Affaires \u2022 ", clientQuotes.length, " Devis"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
        ...
        showToast(`Client ${c.name} s\xE9lectionn\xE9 pour le devis !`);
      }, className: "text-brand-600 font-bold hover:underline" }, "+ Cr\xE9er Devis")));
    })));
  };
  ...
  ), /* @__PURE__ */ React.createElement("aside", { className: "hidden lg:flex flex-col w-64 bg-white border-r border-neutral-200 z-20 shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 flex flex-col gap-3 border-b border-neutral-100 shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement(LogoSVG, { className: "h-8 w-auto" })), /* @__PURE__ */ React.createElement(
  ...
  )), /* @__PURE__ */ React.createElement("nav", { className: "flex-1 overflow-y-auto py-6 px-3 flex flex-col gap-1 custom-scroll", "aria-label": "Menu principal" }, /* @__PURE__ */ React.createElement("p", { className: "px-4 text-[10px] font-extrabold text-neutral-400 uppercase tracking-widest mb-3" }, "Menu Principal"), /* @__PURE__ */ React.createElement(NavItem, { id: "projects", icon: "fa-folder-tree", label: "Affaires & Projets" }), /* @__PURE__ */ React.createElement(NavItem, { id: "clients", icon: "fa-users", label: "Clients (CRM)" }), /* @__PURE__ */ React.createElement(NavItem, { id: "calculator", icon: "fa-calculator", label: "Cr\xE9er un Devis" }), /* @__PURE__ */ React.createElement(NavItem, { id: "savedQuotes", icon: "fa-folder-open", label: "Devis Enregistr\xE9s" }), /* @__PURE__ */ React.createElement(NavItem, { id: "recipes", icon: "fa-layer-group", label: "Catalogue Ouvrages" }), /* @__PURE__ */ React.createElement(NavItem, { id: "materials", icon: "fa-database", label: "Ressources & Prix" })), /* @__PURE__ */ React.createElement("div", { className: "p-4 border-t border-neutral-100 flex flex-col gap-2" }, sbUser && /* @__PURE__ */ React.createElement("div", { className: `flex flex-col gap-1 px-3 py-2.5 rounded-xl text-xs font-semibold border ${sbSyncStatus === "saved" ? "bg-emerald-50 text-emerald-800 border-emerald-200" : sbSyncStatus === "syncing" ? "bg-blue-50 text-blue-800 border-blue-200" : sbSyncStatus === "error" ? "bg-red-50 text-red-800 border-red-200" : "bg-neutral-50 text-neutral-700 border-neutral-200"}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-1.5 font-bold" }, /* @__PURE__ */ React.createElement("i", { className: `fa-solid ${sbSyncStatus === "saved" ? "fa-cloud-check text-emerald-600" : sbSyncStatus === "syncing" ? "fa-arrow-rotate-right fa-spin text-blue-600" : sbSyncStatus === "error" ? "fa-triangle-exclamation text-red-600" : "fa-cloud text-neutral-400"}` }), sbSyncStatus === "saved" && "Synchronis\xE9", sbSyncStatus === "syncing" && "Sauvegarde\u2026", sbSyncStatus === "error" && "Erreur Cloud", sbSyncStatus === "idle" && "Cloud Actif"), lastSavedTime.current && /* @__PURE__ */ React.createElement("span", { className: "text-[10px] opacity-75 font-mono" }, lastSavedTime.current)), /* @__PURE__ */ React.createElement("span", { className: "truncate text-[11px] opacity-80" }, sbUser.email)), hasPermission(activeOrganizationRole, "canViewAudit") && /* @__PURE__ */ React.createElement("button", { onClick: () => setIsAuditModalOpen(true), className: "w-full btn-secondary text-xs py-2 px-3 text-indigo-700 bg-indigo-50/50 hover:bg-indigo-50 border-indigo-200 flex items-center justify-center gap-2 font-bold", "aria-label": "Journal de s\xE9curit\xE9 et audit" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-shield-halved text-indigo-600" }), " Journal d'Audit & S\xE9curit\xE9"), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsCompanyModalOpen(true), className: "w-full btn-secondary text-xs py-2 px-3 text-neutral-700 hover:bg-neutral-50 flex items-center justify-center gap-2", "aria-label": "Param\xE8tres de l'entreprise" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-building text-brand-500" }), " Param\xE8tres Entreprise"), onSignOut && /* @__PURE__ */ React.createElement("button", { onClick: onSignOut, className: "w-full text-xs py-2 px-3 rounded-xl text-neutral-500 hover:text-red-600 hover:bg-red-50 flex items-center justify-center gap-2 font-semibold transition-all", "aria-label": "Se d\xE9connecter" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-arrow-right-from-bracket" }), " D\xE9connexion"))), isMobileDrawerOpen && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 z-[150] lg:hidden flex", role: "dialog", "aria-modal": "true", "aria-label": "Menu de navigation mobile" }, /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 bg-neutral-900/60 backdrop-blur-sm transition-opacity", onClick: () => setIsMobileDrawerOpen(false), "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("div", { className: "relative flex flex-col w-72 max-w-[85vw] bg-white h-full shadow-2xl z-10 animate-fade-in" }, /* @__PURE__ */ React.createElement("div", { className: "p-4 flex items-center justify-between border-b border-neutral-100" }, /* @__PURE__ */ React.createElement(LogoSVG, { className: "h-8" }), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsMobileDrawerOpen(false), className: "btn-icon text-neutral-500 hover:text-neutral-800", "aria-label": "Fermer le menu de navigation" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-xmark text-xl" }))), /* @__PURE__ */ React.createElement("nav", { className: "flex-1 overflow-y-auto p-4 flex flex-col gap-2", "aria-label": "Navigation mobile" }, /* @__PURE__ */ React.createElement("p", { className: "px-3 text-[10px] font-extrabold text-neutral-400 uppercase tracking-widest mb-1" }, "Navigation"), /* @__PURE__ */ React.createElement(NavItem, { id: "projects", icon: "fa-folder-tree", label: "Affaires & Projets", onClickExtra: () => setIsMobileDrawerOpen(false) }), /* @__PURE__ */ React.createElement(NavItem, { id: "clients", icon: "fa-users", label: "Clients (CRM)", onClickExtra: () => setIsMobileDrawerOpen(false) }), /* @__PURE__ */ React.createElement(NavItem, { id: "calculator", icon: "fa-calculator", label: "Cr\xE9er un Devis", onClickExtra: () => setIsMobileDrawerOpen(false) }), /* @__PURE__ */ React.createElement(NavItem, { id: "savedQuotes", icon: "fa-folder-open", label: "Devis Enregistr\xE9s", onClickExtra: () => setIsMobileDrawerOpen(false) }), /* @__PURE__ */ React.createElement(NavItem, { id: "recipes", icon: "fa-layer-group", label: "Catalogue Ouvrages", onClickExtra: () => setIsMobileDrawerOpen(false) }), /* @__PURE__ */ React.createElement(NavItem, { id: "materials", icon: "fa-database", label: "Ressources & Prix", onClickExtra: () => setIsMobileDrawerOpen(false) })), /* @__PURE__ */ React.createElement("div", { className: "p-4 border-t border-neutral-100 space-y-2" }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setIsCompanyModalOpen(true);
    setIsMobileDrawerOpen(false);
  }, className: "w-full btn-secondary text-xs py-2 px-3 justify-center", "aria-label": "Param\xE8tres entreprise" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-building text-brand-500 mr-2" }), " Param\xE8tres Entreprise"), onSignOut && /* @__PURE__ */ React.createElement("button", { onClick: onSignOut, className: "w-full text-xs py-2 px-3 rounded-xl text-neutral-500 hover:text-red-600 hover:bg-red-50 flex items-center justify-center gap-2 font-semibold", "aria-label": "D\xE9connexion" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-arrow-right-from-bracket" }), " D\xE9connexion")))), /* @__PURE__ */ React.createElement("div", { className: "flex-1 flex flex-col h-full overflow-hidden relative" }, /* @__PURE__ */ React.createElement("header", { className: "lg:hidden shrink-0 h-16 bg-white border-b border-neutral-200 z-30 flex items-center justify-between px-4 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement(
    "button",
    {
  ...
  ), /* @__PURE__ */ React.createElement(LogoSVG, { className: "h-7" })), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: `flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold border ${isOnline ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-amber-50 text-amber-800 border-amber-300"}` }, /* @__PURE__ */ React.createElement("span", { className: `w-1.5 h-1.5 rounded-full ${isOnline ? "bg-emerald-500" : "bg-amber-500"}` }), /* @__PURE__ */ React.createElement("span", null, isOnline ? "En ligne" : "Hors-ligne")), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setIsCompanyModalOpen(true),
  ...
  ), viewingSavedQuote && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 bg-neutral-900/75 backdrop-blur-sm flex items-center justify-center z-[120] p-4 overflow-y-auto" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-3xl shadow-floating w-full max-w-4xl flex flex-col max-h-[92dvh] overflow-hidden my-auto" }, /* @__PURE__ */ React.createElement("div", { className: "px-6 py-4 border-b border-neutral-100 flex justify-between items-center bg-white shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-extrabold text-brand-600 bg-brand-50 px-3 py-1 rounded-lg" }, viewingSavedQuote.number), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { className: "font-extrabold text-neutral-900 text-lg leading-tight" }, viewingSavedQuote.clientName), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500" }, viewingSavedQuote.projectRef, " \u2022 ", viewingSavedQuote.date))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex bg-neutral-100 p-1 rounded-xl" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setIsCommercialMode(false), className: `px-3 py-1.5 text-xs font-bold rounded-lg transition-all ${!isCommercialMode ? "bg-white text-neutral-900 shadow-sm" : "text-neutral-500"}`, "aria-label": "Afficher la vue \xE9tude interne" }, "Vue Interne (\xC9tude)"), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsCommercialMode(true), className: `px-3 py-1.5 text-xs font-bold rounded-lg transition-all ${isCommercialMode ? "bg-brand-600 text-white shadow-sm" : "text-neutral-500"}`, "aria-label": "Afficher le devis commercial propre" }, "Devis Commercial Client Clean")), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsShareModalOpen(true), className: "btn-secondary py-1.5 px-3 text-xs flex items-center gap-1.5 font-bold", title: "Partager le devis au client", "aria-label": "Partager le devis" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-share-nodes text-brand-600" }), /* @__PURE__ */ React.createElement("span", null, "Partager")), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsSignatureModalOpen(true), className: "btn-secondary py-1.5 px-3 text-xs flex items-center gap-1.5 font-bold text-emerald-700 hover:bg-emerald-50 border-emerald-200", title: "Signer \xE9lectroniquement", "aria-label": "Signer le devis" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-signature text-emerald-600" }), /* @__PURE__ */ React.createElement("span", null, "Signer")), /* @__PURE__ */ React.createElement("button", { onClick: () => window.print(), className: "btn-primary py-1.5 px-3.5 text-xs flex items-center gap-1.5 font-bold shadow-md shadow-brand-500/20", title: "Imprimer ou Enregistrer en PDF (A4)", "aria-label": "Imprimer le devis" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-print" }), /* @__PURE__ */ React.createElement("span", null, "Imprimer / PDF")), /* @__PURE__ */ React.createElement("button", { onClick: () => setViewingSavedQuote(null), className: "btn-icon w-8 h-8", "aria-label": "Fermer la bo\xEEte de dialogue" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-xmark text-xl" })))), /* @__PURE__ */ React.createElement("div", { className: "p-6 overflow-y-auto custom-scroll bg-neutral-50/50 space-y-6" }, isCommercialMode ? /* @__PURE__ */ React.createElement("div", { className: "bg-white p-8 rounded-2xl border border-neutral-200 shadow-sm space-y-6 print:border-0 print:p-0", id: "printArea" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start border-b border-neutral-200 pb-6" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 mb-2" }, /* @__PURE__ */ React.createElement(LogoSVG, { className: "h-10" })), /* @__PURE__ */ React.createElement("p", { className: "text-xs font-bold text-neutral-800" }, viewingSavedQuote.companyInfoSnapshot?.name || companyInfo.name), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500 font-medium" }, viewingSavedQuote.companyInfoSnapshot?.tagline || companyInfo.tagline), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500 font-medium" }, "Adresse: ", viewingSavedQuote.companyInfoSnapshot?.address || companyInfo.address), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500 font-medium" }, "Contact: ", viewingSavedQuote.companyInfoSnapshot?.email || companyInfo.email, " \u2022 Tel: ", viewingSavedQuote.companyInfoSnapshot?.phone || companyInfo.phone), /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-neutral-400" }, "NIF: ", viewingSavedQuote.companyInfoSnapshot?.nif || companyInfo.nif, " \u2022 RCCM: ", viewingSavedQuote.companyInfoSnapshot?.rccm || companyInfo.rccm)), /* @__PURE__ */ React.createElement("div", { className: "text-right" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-black text-brand-600 uppercase tracking-tight" }, "DEVIS COMMERCIAL"), /* @__PURE__ */ React.createElement("p", { className: "text-sm font-bold text-neutral-800 mt-1" }, "N\xB0 : ", viewingSavedQuote.number), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-neutral-500" }, "Date : ", viewingSavedQuote.date))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-6 bg-neutral-50 p-4 rounded-xl border border-neutral-200" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] font-extrabold text-neutral-400 uppercase tracking-wider mb-1" }, "CLIENT"), /* @__PURE__ */ React.createElement("p", { className: "font-extrabold text-neutral-900 text-base" }, viewingSavedQuote.clientName)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "text-[10px] font-extrabold text-neutral-400 uppercase tracking-wider mb-1" }, "D\xC9SIGNATION CHANTIER"), /* @__PURE__ */ React.createElement("p", { className: "font-bold text-neutral-800" }, viewingSavedQuote.projectRef))), viewingSavedQuote.notes && /* @__PURE__ */ React.createElement("div", { className: "p-3.5 bg-amber-50/60 border border-amber-200 rounded-xl text-xs text-amber-900" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-[10px] uppercase text-amber-700 tracking-wider mb-1" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-note-sticky mr-1" }), "Notes & Remarques :"), /* @__PURE__ */ React.createElement("p", { className: "whitespace-pre-line" }, viewingSavedQuote.notes)), /* @__PURE__ */ React.createElement("table", { className: "w-full text-left text-xs border-collapse" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { className: "bg-neutral-900 text-white font-bold uppercase" }, /* @__PURE__ */ React.createElement("th", { className: "p-3.5 rounded-l-lg" }, "D\xE9signation Ouvrage / Prestation Commerciale"), /* @__PURE__ */ React.createElement("th", { className: "p-3.5 text-center" }, "Quantit\xE9"), /* @__PURE__ */ React.createElement("th", { className: "p-3.5 text-right" }, "Prix Unitaire HT"), /* @__PURE__ */ React.createElement("th", { className: "p-3.5 text-right rounded-r-lg" }, "Total HT"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-neutral-100" }, viewingSavedQuote.quoteData?.commercialItems?.map((item) => /* @__PURE__ */ React.createElement("tr", { key: item.id }, /* @__PURE__ */ React.createElement("td", { className: "p-3.5" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-neutral-900" }, item.label), item.dimensionSummary && /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-neutral-500 mt-0.5 font-medium" }, item.dimensionSummary)), /* @__PURE__ */ React.createElement("td", { className: "p-3.5 text-center font-medium" }, item.billedQty.toFixed(2), " ", item.unit), /* @__PURE__ */ React.createElement("td", { className: "p-3.5 text-right font-medium" }, formatMoney(item.sellingUnitHT, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency)), /* @__PURE__ */ React.createElement("td", { className: "p-3.5 text-right font-bold text-neutral-900" }, formatMoney(item.sellingTotalHT, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency)))))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-end pt-4 border-t border-neutral-200" }, /* @__PURE__ */ React.createElement("div", { className: "w-72 space-y-2 text-xs" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between font-bold text-neutral-800 text-sm" }, /* @__PURE__ */ React.createElement("span", null, "Net HT Client :"), /* @__PURE__ */ React.createElement("span", null, formatMoney(viewingSavedQuote.quoteData?.netHTConsomme, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between text-neutral-500" }, /* @__PURE__ */ React.createElement("span", null, "TVA (", viewingSavedQuote.vatRate !== void 0 ? viewingSavedQuote.vatRate : 18, "%) :"), /* @__PURE__ */ React.createElement("span", null, "+", formatMoney(viewingSavedQuote.quoteData?.tvaConsomme, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))), /* @__PURE__ */ React.createElement("div", { className: "flex justify-between font-black text-brand-600 text-base border-t-2 border-neutral-900 pt-2" }, /* @__PURE__ */ React.createElement("span", null, "TOTAL TTC :"), /* @__PURE__ */ React.createElement("span", null, formatMoney(viewingSavedQuote.quoteData?.totalTTCConsomme, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))))), /* @__PURE__ */ React.createElement("div", { className: "pt-4 border-t border-neutral-200" }, /* @__PURE__ */ React.createElement("h4", { className: "text-xs font-black text-neutral-800 uppercase tracking-wider mb-2 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-calendar-check text-brand-600" }), "\xC9ch\xE9ancier Pr\xE9visionnel des R\xE8glements BTP"), /* @__PURE__ */ React.createElement("div", { className: "border border-neutral-200 rounded-xl overflow-hidden shadow-2xs" }, /* @__PURE__ */ React.createElement("table", { className: "w-full text-left text-xs" }, /* @__PURE__ */ React.createElement("thead", { className: "bg-neutral-50 border-b border-neutral-200 text-[10px] font-extrabold text-neutral-500 uppercase" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { className: "p-2.5 pl-3" }, "\xC9tape de Travaux"), /* @__PURE__ */ React.createElement("th", { className: "p-2.5 text-center" }, "Taux (%)"), /* @__PURE__ */ React.createElement("th", { className: "p-2.5 text-right pr-3" }, "Montant TTC"))), /* @__PURE__ */ React.createElement("tbody", { className: "divide-y divide-neutral-100 font-medium" }, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { className: "p-2.5 pl-3" }, "Acompte \xE0 la signature et d\xE9marrage des travaux"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-center font-bold text-neutral-700" }, "40%"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-right pr-3 font-mono font-bold text-neutral-900" }, formatMoney((viewingSavedQuote.quoteData?.totalTTCConsomme || 0) * 0.4, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { className: "p-2.5 pl-3" }, "Situation interm\xE9diaire / Avancement gros \u0153uvre & hors d'eau"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-center font-bold text-neutral-700" }, "30%"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-right pr-3 font-mono font-bold text-neutral-900" }, formatMoney((viewingSavedQuote.quoteData?.totalTTCConsomme || 0) * 0.3, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))), /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("td", { className: "p-2.5 pl-3" }, "Second \u0153uvre, finitions et \xE9quipements"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-center font-bold text-neutral-700" }, "20%"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-right pr-3 font-mono font-bold text-neutral-900" }, formatMoney((viewingSavedQuote.quoteData?.totalTTCConsomme || 0) * 0.2, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))), /* @__PURE__ */ React.createElement("tr", { className: "bg-neutral-50/60 font-bold" }, /* @__PURE__ */ React.createElement("td", { className: "p-2.5 pl-3 text-brand-700" }, "Solde \xE0 la r\xE9ception d\xE9finitive et remise des cl\xE9s"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-center text-brand-700" }, "10%"), /* @__PURE__ */ React.createElement("td", { className: "p-2.5 text-right pr-3 font-mono text-brand-700" }, formatMoney((viewingSavedQuote.quoteData?.totalTTCConsomme || 0) * 0.1, viewingSavedQuote.companyInfoSnapshot?.currency || companyInfo.currency))))))), /* @__PURE__ */ React.createElement("div", { className: "pt-8 border-t border-neutral-100 grid grid-cols-2 gap-8 text-[11px] text-neutral-500" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-neutral-700 mb-1" }, "Conditions de r\xE8glement :"), /* @__PURE__ */ React.createElement("p", null, viewingSavedQuote.companyInfoSnapshot?.paymentTerms || companyInfo.paymentTerms), /* @__PURE__ */ React.createElement("p", { className: "mt-1" }, "Validit\xE9 de l'offre : ", viewingSavedQuote.companyInfoSnapshot?.quoteValidity || companyInfo.quoteValidity)), /* @__PURE__ */ React.createElement("div", { className: "text-center border border-dashed border-neutral-300 p-4 rounded-xl" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-neutral-700 mb-8" }, "Bon pour accord et signature client :"), /* @__PURE__ */ React.createElement("p", { className: "text-[10px] text-neutral-400" }, "Date et cachet")))) : /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, (() => {
  ...
  })())), /* @__PURE__ */ React.createElement("div", { className: "px-6 py-4 border-t border-neutral-100 bg-white flex justify-end gap-3 shrink-0" }, /* @__PURE__ */ React.createElement("button", { onClick: () => window.print(), className: "btn-secondary" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-print" }), " Imprimer Devis"), /* @__PURE__ */ React.createElement("button", { onClick: () => setViewingSavedQuote(null), className: "btn-primary" }, "Fermer")))), showImportBanner && /* @__PURE__ */ React.createElement("div", { className: "fixed inset-0 bg-neutral-900/60 backdrop-blur-sm flex items-center justify-center z-[135] p-4" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-3xl shadow-floating w-full max-w-lg overflow-hidden p-8 text-center animate-fade-in" }, /* @__PURE__ */ React.createElement("div", { className: "w-16 h-16 rounded-full bg-brand-50 text-brand-600 flex items-center justify-center mx-auto mb-5" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-[#fa-file-import] fa-cloud-arrow-down text-3xl" })), /* @__PURE__ */ React.createElement("h3", { className: "font-extrabold text-neutral-900 text-xl mb-2" }, "Donn\xE9es locales non associ\xE9es d\xE9tect\xE9es"), /* @__PURE__ */ React.createElement("p", { className: "text-neutral-600 text-sm font-medium mb-6 leading-relaxed" }, "Des donn\xE9es chiffr\xE9es/catalogue cr\xE9\xE9es pr\xE9c\xE9demment sur ce navigateur sont disponibles. Souhaitez-vous les **importer dans votre compte cloud (", sbUser?.email, ")** ou d\xE9marrer avec une base vierge ?"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
