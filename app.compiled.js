...
Veuillez d'abord modifier les recettes qui l'utilisent avant de la supprimer.`,
  ...
  const renderProjects = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-6 items-start" }, /* @__PURE__ */ React.createElement("div", { className: `${selectedProject ? "hidden lg:flex" : "flex"} w-full lg:w-[380px] shrink-0 flex-col gap-4 lg:sticky lg:top-4 lg:max-h-[calc(100dvh-2rem)]` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-1" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-bold text-neutral-800" }, "Affaires & Projets"), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
  ...
  const renderClients = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "w-full max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-6 items-start" }, /* @__PURE__ */ React.createElement("div", { className: `${selectedClient ? "hidden lg:flex" : "flex"} w-full lg:w-[380px] shrink-0 flex-col gap-4 lg:sticky lg:top-4 lg:max-h-[calc(100dvh-2rem)]` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between px-1" }, /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-bold text-neutral-800" }, "Clients & Donneurs d'Ordres"), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
