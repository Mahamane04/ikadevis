...
function WorkItemTable({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "p-4 sm:p-6 space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "sm:hidden space-y-3" }, items.map((item, idx) => {
    ...
    ), item.calcForm && /* @__PURE__ */ React.createElement("span", { className: "inline-block text-[10px] font-mono text-neutral-400 pl-2" }, "Mode: ", item.calcForm.takeoffMode || "rectangle", " \u2022 ", item.calcForm.width, "m \xD7 ", item.calcForm.height, "m"), item.isCustom && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 pl-2 pt-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-[10px] font-bold text-amber-700 uppercase tracking-wide shrink-0" }, "Co\xFBt d'achat/u :"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: "0",
        ...
        "aria-label": `Co\xFBt d'achat pour ${item.name}`
      }
    ), !item.costUnit && /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-triangle-exclamation text-amber-500 text-[10px]", title: "Sans co\xFBt, cette ligne ne compte pas dans le d\xE9bours\xE9 du lot" })))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-2.5 pt-2 border-t border-neutral-100" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-[10px] font-extrabold text-neutral-400 uppercase tracking-wider block mb-1" }, "Quantit\xE9"), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: "1",
    ...
    ), !item.costUnit && /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-triangle-exclamation text-amber-500 text-[10px]", title: "Sans co\xFBt, cette ligne ne compte pas dans le d\xE9bours\xE9 du lot" }))))), /* @__PURE__ */ React.createElement("td", { className: "py-3 px-3 text-center" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
        min: "1",
...
function QuoteTotalsBar({
  ...
  return (
    ...
    /* @__PURE__ */ React.createElement("div", { className: "quote-totals-bar bg-white/95 backdrop-blur-md border-t border-neutral-200 p-3 sm:p-4 shadow-floating" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-[1700px] mx-auto flex flex-wrap items-center justify-between gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-3 sm:gap-5 text-xs" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-neutral-400 block uppercase font-bold flex items-center gap-1" }, "D\xE9bours\xE9 Sec", hasIncompleteCustomLines && /* @__PURE__ */ React.createElement("span", { className: "text-amber-600 font-bold", title: "Une ou plusieurs lignes libres n'ont pas de co\xFBt d'achat renseign\xE9 \u2014 ce montant ne les inclut pas" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-triangle-exclamation" }))), /* @__PURE__ */ React.createElement("span", { className: "font-mono font-bold text-neutral-700 text-sm" }, formatMoney(totalDebourse, currency), hasIncompleteCustomLines && /* @__PURE__ */ React.createElement("sup", { className: "text-amber-600" }, "*"))), /* @__PURE__ */ React.createElement("div", { className: "pl-3 border-l border-neutral-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-neutral-400 block uppercase font-bold" }, "Coeff K"), /* @__PURE__ */ React.createElement("span", { className: "font-mono font-black text-indigo-600 text-sm bg-indigo-50 px-2 py-0.5 rounded-md border border-indigo-200" }, "K=", kFactor, hasIncompleteCustomLines && /* @__PURE__ */ React.createElement("sup", null, "*"))), /* @__PURE__ */ React.createElement("div", { className: "pl-3 border-l border-neutral-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-neutral-400 block uppercase font-bold" }, "Total Net HT"), /* @__PURE__ */ React.createElement("span", { className: "font-extrabold text-neutral-900 text-sm sm:text-base" }, formatMoney(totalHT, currency))), /* @__PURE__ */ React.createElement("div", { className: "hidden sm:block pl-3 border-l border-neutral-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-neutral-400 block uppercase font-bold flex items-center gap-1" }, "Marge R\xE9elle", isLowProfit && /* @__PURE__ */ React.createElement("span", { className: "text-amber-600 font-bold", title: "Marge faible (< 15%)" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-triangle-exclamation" })), hasIncompleteCustomLines && /* @__PURE__ */ React.createElement("sup", { className: "text-amber-600" }, "*")), /* @__PURE__ */ React.createElement("span", { className: `font-bold text-sm sm:text-base ${isLowProfit ? "text-amber-600" : "text-emerald-600"}` }, "+", formatMoney(marginVal, currency), " (", marginPct, "%)")), /* @__PURE__ */ React.createElement("div", { className: "hidden md:block pl-3 border-l border-neutral-200" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-neutral-400 block uppercase font-bold" }, "TVA (", quote.vatRate || 18, "%)"), /* @__PURE__ */ React.createElement("span", { className: "font-medium text-neutral-600 text-sm" }, "+", formatMoney(totalTVA, currency))), /* @__PURE__ */ React.createElement("div", { className: "pl-3 border-l-2 border-neutral-900" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-brand-600 block uppercase font-black" }, "TOTAL TTC"), /* @__PURE__ */ React.createElement("span", { className: "font-black text-brand-600 text-base sm:text-xl" }, formatMoney(totalTTC, currency)))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        onClick: onPreviewQuote,
    ...
    ))), hasIncompleteCustomLines && /* @__PURE__ */ React.createElement("div", { className: "max-w-[1700px] mx-auto mt-1.5 text-[11px] text-amber-700 font-semibold flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement("i", { className: "fa-solid fa-circle-info" }), "* Hors lignes libres sans co\xFBt d'achat renseign\xE9 \u2014 compl\xE9tez-les pour une marge fiable."))
  );
}
